...
/**
 * SERVLET QUE INSERTA UNA MACETA EN LA BASE DE DATOS
 */
@WebServlet("/NewMaceta")
public class NewMaceta extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try 
		{
			...
			int value =Logic.storeNewMaceta(descripcion, usuario_id, tipo_id);
