 ...
 */
public class TaskSensores extends AsyncTask<String,Void, String>
{
    private String tag = "TaskSelectStation";
    private MacetaActivity activity;
    private String urlStr = "";

    public TaskSensores(MacetaActivity activity)
    {
    ...
    protected void onPostExecute(String response)
    {
        ...
        try
        {
            ...
            if(urlStr.contains("GetSensoresMaceta"))
            {
                activity.setListSensores(jsonarray);
            }
        }catch (Exception e)
        {
