 ...
 */
public class TaskStationValues extends AsyncTask<String,Void, String>
{
    private String tag = "TaskSelectStation";
    private StationActivity activity;
    private String urlStr = "";

    public TaskStationValues(StationActivity activity)
    {
    ...
    protected void onPostExecute(String response)
    {
        ...
        try
        {
            ...
            if(urlStr.contains("GetStationSensors"))
            {
