...
import com.uah.wheatherstation.SelectMaceta;
 ...
 */
public class TaskSelectMaceta extends AsyncTask<String,Void, String>
{
    private String tag = "TaskSelectMaceta";
    private SelectMaceta activity;
    private String urlStr = "";

    public TaskSelectMaceta(SelectMaceta activity)
    {
    ...
    protected void onPostExecute(String response)
    {
        ...
        try
        {
            ...
            if(urlStr.contains("GetMacetasUsuario"))
            {
                activity.setListMacetas(jsonarray);
            }
        }catch (Exception e)
        {
